 ...
 */
MapTo('nnp/components/navigation')(NavigationV1Component, {isEmpty: NavigationV1IsEmptyFn});
MapTo('nnp/components/separator')(SeparatorV1Component);

MapTo('nnp/components/container')(ContainerV1Component, {isEmpty: ContainerIsEmptyFn});
MapTo('nnp/components/experiencefragment')(ContainerV1Component, {isEmpty: ContainerIsEmptyFn});

MapTo('nnp/components/download')(DownloadV1Component,{isEmpty: DownloadV1IsEmptyFn});
MapTo('nnp/components/languagenavigation')(LanguageNavigationV1Component);
MapTo('nnp/components/list')(ListV2Component, {isEmpty: ListV2IsEmptyFn});
MapTo('nnp/components/breadcrumb')(BreadCrumbV2Component, {isEmpty: BreadCrumbV2IsEmptyFn});
MapTo('nnp/components/button')(ButtonV1Component, {isEmpty: ButtonV1IsEmptyFn});
MapTo('nnp/components/image')(ImageV2Component, {isEmpty: ImageV2IsEmptyFn});
MapTo('nnp/components/title')(TitleV2Component, {isEmpty: TitleV2IsEmptyFn});

MapTo('nnp/components/accordion')(AccordionV1Component);
MapTo('nnp/components/tabs')(TabsV1Component);
...
LazyMapTo('nnp/components/teaser')(TeaserV1Component);
...
LazyMapTo('nnp/components/carousel')(CarouselV1Component);
...
LazyMapTo('nnp/components/text')(LazyTextModule, TextEditConfig);